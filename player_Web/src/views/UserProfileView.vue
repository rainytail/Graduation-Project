    ...
    <ContentBase>
        <div class="row">
            <div class="col-3">
                ...
                <UserProfileL @showfriends="showfriends" @showSettings="showSettings" @follow="follow" @unfollow="unfollow" :user="user"></UserProfileL>
                <UserProfileWrite @post_a_post="post_a_post"></UserProfileWrite>
            </div>
            <div class="col-9">
                <UserProfileSettings v-if="now_display==='settings'"></UserProfileSettings>
...
export default {
    ...
    setup() {
        ...
        const showSettings = () => {
            now_display.value = "settings";
            console.log("修改now display为settings");
        };
