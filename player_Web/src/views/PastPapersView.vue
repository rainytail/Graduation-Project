...
<template>
    <ContentBase>
        <div class="container text-center" style="">
            <div class="row">
                <div class="card col-3" style="margin-right: 80px;">
                    <div class="card-body">
                        <div class="d-flex flex-column mb-3" style="align-items: center;">
                            <button @click="clk_0" type="button" class="btn btn-outline-primary">小学</button>
                            <button @click="clk_1" type="button" class="btn btn-outline-primary">初中</button>
                            <button @click="clk_2" type="button" class="btn btn-outline-primary">高中</button>
                            <button @click="clk_3" type="button" class="btn btn-outline-primary">大学</button>
                            <button @click="clk_4" type="button" class="btn btn-outline-primary">四级</button>
                            <button @click="clk_5" type="button" class="btn btn-outline-primary">六级</button>
                            <button @click="clk_6" type="button" class="btn btn-outline-primary">雅思</button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <button @click="download(audio)" type="button" class="btn btn-primary">保存音频</button>
                                        
                                        <button @click="golisten(audio)" type="button" class="btn btn-primary">前往练习</button>
                                    </div>
                                </div>
                            </div>
                        </div>
