<template>
    <div class="card" style="margin-right: 20px;">
        <div class="card-body" style="width: 30%;">
            <textarea @change="change" class="textarea" placeholder="write your note" name="" id="text" cols="20" rows="6"></textarea>
            <button style="width: 100%;" @click.prevent="submit" type="button" class="btn btn-outline-secondary">记录</button>
        </div>
    </div>
</template>
