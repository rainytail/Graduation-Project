...
<ContentBase>
        ...
        <div class="card">
            <div class="card-body">
                <!-- <div class="row"> -->
                    <!-- <div class="col-4"> -->
                        <!-- 头像 -->
                        <UserCard style="width: 100%; height: 80%;" :share="share"></UserCard>
                    <!-- </div> -->
                    <!-- <div class="col-8"> -->
                        <!-- 发布 -->
    ...
    <div v-if="showModal" class="modal">
        <div class="modal-content">
            ...
            <!-- 上传文件的按钮 -->
            <button @click="post_submit" style="width: 100%; margin-top: 10px;" type="button" class="btn btn-outline-secondary">发表</button>
        </div>
    </div>
</ContentBase>
